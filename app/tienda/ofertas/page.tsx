...
export default function Page() {
  return (
    <main className="p-12 bg-slate-950 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-slate-900 p-6 rounded-3xl border-2 border-red-500/50">
          <div className="relative h-36 mb-5 rounded-2xl overflow-hidden border border-red-400/30 bg-black/20">
            <Image
        ...
        <div className="bg-slate-900 p-6 rounded-3xl border-2 border-yellow-500/50">
          ...
          <h3 className="text-3xl font-black text-white">Super Oferta Gamer</h3>
          <p className="text-slate-400 mt-2">50% OFF + envíos gratis</p>
          <div className="mt-4 flex items-center gap-4">
            <span className="text-4xl font-bold text-yellow-500">19€/mes</span>
